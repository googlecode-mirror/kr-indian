...
<?php endif;  endif;  if (Phpfox ::getParam('friend.load_friends_online_ajax') && PHPFOX_IS_AJAX): ?>
<script type="text/javascript">$('#js_total_block_friends_onlin').html('<?php echo $this->_aVars['iTotalFriendsOnline']; ?>');</script>
<?php endif; ?>
