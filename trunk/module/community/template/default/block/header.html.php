...
<div class="community_header">
    <div class="community_header_left">
        ...
        <div class="preview_image_panel">{foreach from=$aPreviews item=aPreview}<span>{img path='community.url_image' file=$aPreview.image_path server_id=$aPreview.server_id suffix=$aPreview.suffix}</span>{/foreach}</div>
    </div>
