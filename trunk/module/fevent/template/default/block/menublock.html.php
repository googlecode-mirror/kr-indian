...
<div class="item_bar">
    ...
    {/if}
        ...
        <!--<button class="item_bar_action">...</button> -->
        <div class="item_bar_action">
    <div class="left_block_menu_action">Action <label class="left_block_menu_action_label">...</label></div></div>
        <ul>
