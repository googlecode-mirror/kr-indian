    ...
    class Event_Service_Callback extends Phpfox_Service 
    {
        ...
        */
        ...
        public function getOrganizationMenu($aOrganization)
        {
            ...
            $aMenus[] = array(
                'phrase' => Phpfox::getPhrase('organization.events'),
                'url' => Phpfox::getService('organization')->getUrl($aOrganization['organization_id'], $aOrganization['title'], $aOrganization['vanity_url']) . 'event/',
                'icon' => 'module/event.png',
                'landing' => 'event'
            );
        ...
        {
            if (!Phpfox::getService('organization')->hasPerm($aOrganization['organization_id'], 'event.share_events'))
            {
                return null;
            }        
