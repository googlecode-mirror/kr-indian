$Core.Pages = {
	...
	{
		$.ajaxCall('pages.setCoverPhoto', 'organization_id=' + iPageId + '&photo_id=' + iPhotoId);
	},
	...
	removeCover : function(iPageId)
	{
		...
		{
			$.ajaxCall('pages.removeCoverPhoto', 'organization_id=' + iPageId);
		}
	}
};
$Behavior.organizationBuilder = function(){ 
	...
	if ($Core.exists('#js_pages_add_holder')){
		...
		$('.pages_type_add_form_holder form').submit(function(){
			...
			$(this).ajaxCall('organization.add');
			return false;
		});
