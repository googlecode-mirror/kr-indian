...
$(document).ready(function(e){
    $('#nb_body').prepend('<div class="header_info"><div class="header_info_content"><div class="header_info_left">OUR VISION</div><div class="header_line"></div><div class="header_info_right"><p>Healthier Earth, the first global social networking site based around volunteering to move Earth<br>forward and begin the New Golden Age on Earth founded on Love, Peace and Harmony for all. </p></div></div></div>'); 
    $('.user_register_holder').append('<div class="swap_bg"><img class="bg_image" src="http://kr.decodegroups.com/file/pic/background.jpg"/></div>')
	...
	$('.swap_bg').css('min-height',($(window).height() - 100) + 'px');
