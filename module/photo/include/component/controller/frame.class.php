...
class Photo_Component_Controller_Frame extends Phpfox_Component
{
	...
	public function process()
	{
		...
		if (count($aImages))
		{
            ...
            if (isset($aVals['organization_id']) && $aVals['organization_id'] > 0)
            {              
