...
<?php if (isset ( $this->_aVars['iTotalHide'] ) && isset ( $this->_aVars['iMenuCnt'] ) && $this->_aVars['iMenuCnt'] > $this->_aVars['iTotalHide']): ?>
						<a href="#" class="js_view_more_features js_view_more" id="js_view_more_features" rel="more"><?php echo Phpfox::getPhrase('theme.view_more'); ?></a>
						<a href="#" class="js_view_more_features js_view_less" id="js_view_less_features" rel="less" style="display:none;"><?php echo Phpfox::getPhrase('theme.view_less'); ?></a>
<?php endif; ?>
